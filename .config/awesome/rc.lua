...
beautiful.init("/home/grindo/.config/awesome/theme.lua")
...
mytextclock = wibox.widget.textclock(" %e %b %H:%M", 15)
...
awful.screen.connect_for_each_screen(function(s)
    ...
    --awful.tag({ "web", "dcmd", "3", "4", "5", "6", "7", "8", "9" }, s, awful.layout.layouts[1])
    awful.tag.add("web", {
...
awful.rules.rules = {
    ...
    -- Set Double commander start at tag "dcmd"
...
-- Start wireless widget
awful.spawn.with_shell("wicd-client -t")
